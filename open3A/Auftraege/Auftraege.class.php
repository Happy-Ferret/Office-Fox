...
class Auftraege extends anyC implements iPluginSpecificRestrictions {
	...
	function getPluginSpecificRestrictions(){
		$a = array(
			...
			"pluginSpecificCantCreateL" => "kann keine Lieferscheine erstellen",
			"pluginSpecificCantCreateG" => "kann keine Gutschriften erstellen",
			"pluginSpecificCantCreateA" => "kann keine Angebote erstellen",
			"pluginSpecificRLocksAuftrag" => "Rechnung sperrt alle Belege"
			);
		$Us = new Users();
	...
	public static function getStatus(){
		$status = array("open" => "offen", "confirmed" => "bestätigt", "delivered" => "geliefert", "billed" => "berechnet", "credited" => "gutgeschrieben");
	...
	public static function getStatusIcons(){
		$status = array("open" => "book_alt2", "confirmed" => "check", "delivered" => "box", "billed" => "book_alt", "declined" => "x", "billedPartly" => "hash", "credited" => "plus");
