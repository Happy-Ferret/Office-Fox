...
class Spreadsheet_Excel_Workbook extends Spreadsheet_Excel_BIFFwriter
{
    /**
    ...
    */
    function __construct($filename)
    {
        ...
        $this->_parser           = new Spreadsheet_Excel_Parser($this->_byte_order, $this->_BIFF_version);
        $this->_1904             = 0;
        $this->_activesheet      = 0;
        $this->_firstsheet       = 0;
        $this->_selected         = 0;
        ...
        $this->_tmp_format       = new Spreadsheet_Excel_Format($this->_BIFF_version);
    ...
    */
    function &addWorksheet($name = '')
    {
        ...
        $worksheet = new Spreadsheet_Excel_Worksheet($this->_BIFF_version,
                                   $name, $index,
    ...
    */
    ...
    {
        $format = new Spreadsheet_Excel_Format($this->_BIFF_version, $this->_xf_index, $properties);
        $this->_xf_index += 1;
    ...
    function &addValidator()
    {
        ...
        $valid = new Spreadsheet_Excel_Validator($this->_parser);
        return $valid;
    }
