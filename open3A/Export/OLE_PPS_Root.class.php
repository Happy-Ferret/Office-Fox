...
class OLE_PPS_Root extends OLE_PPS
{
    ...
    */
    ...
    {
        $this->_tmp_dir = Util::getTempFilename();#System::tmpdir();
        $this->OLE_PPS(
           null, 
    ...
    */
    function save($filename)
    {
        ...
        if (($filename == '-') || ($filename == '')) {
            $this->_tmp_filename = Util::getTempFilename("OLE_PPS_Root");#tempnam($this->_tmp_dir, "OLE_PPS_Root");
            $this->_FILEH_ = @fopen($this->_tmp_filename,"w+b");
            if ($this->_FILEH_ == false) {
                return die("Can't create temporary file ".$this->_tmp_filename);
            }
        } else {
